...
public class PageController {
    ...
    public String order_alarm_html() {
        return "page_order_alarm";
    }
    ...
    public String order_dead_html() {
        return "page_order_dead";
    }
    ...
    public String page_index_viewer() {
        return "page_index_viewer";
    }

    @RequestMapping(value = "admin_user.html")
    public String admin_user_html() {
        return "page_admin_user";
    }

    @RoleCheck(level = {3})
    @RequestMapping(value = "page_admin.html")
    public String page_admin_html() {
        return "page_admin";
    }

    @RequestMapping(value = "page_index.html")
    public String page_index_html() {
        return "page_index";
    }

    @RequestMapping(value = "page_order_viewer.html")
    public String page_order_viewer() {
        return "page_bound_viewer";
    }
}
